...
function checker(){
    ...
    check_amount_input()
    check_name_input()
    document.getElementById("add_btn").disabled = document.getElementById("errors").children.length > 0;
}
...
function updateTable(newProduct){
    ...
    for (let child of Array.from(document.getElementById("product_table").children).slice(1)){
